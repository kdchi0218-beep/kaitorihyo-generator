  ...
  return (
    <div className="space-y-2">
      ...
      <SettingRow label="枠線幅">
        ...
        />
        <span className="text-xs text-[#7a7060] w-4">{settings.cardBorderWidth}</span>
      </SettingRow>
      ...
      <SettingRow label="角丸">
        ...
        />
        <span className="text-xs text-[#7a7060] w-4">{settings.cardBorderRadius}</span>
      </SettingRow>
      ...
      <div className="pt-2 border-t border-[#e0d9c8]">
        ...
        <p className="text-[10px] text-[#a09580] mt-1">PSA10カードの下部にPSAロゴをオーバーレイ表示</p>
      </div>
    </div>
  )
}
